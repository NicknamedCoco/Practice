...
<h2>订单管理</h2>
<div id="add-order">
    <a href="${pageContext.request.contextPath}/order_add_page" target="rightFrame">新增订单</a>
</div>
<hr/>
<table border="1">
    <tr>
    ...
    <c:forEach items="${ orderList }" var="order" varStatus="status">
        <tr>
            ...
            <td>${ order.price }</td>
            <td>
                <a href="${pageContext.request.contextPath}/order_delete?id=${ order.id }">删除</a>
                |
                <a href="${pageContext.request.contextPath}/order_update_page?id=${ order.id }">修改</a>
            </td>
        </tr>
    </c:forEach>
